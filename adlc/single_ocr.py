...
class TesseractCharReader:
    def __init__(self, path = str(Path.home() / ".local/share/tessdata")) -> None:
    ...
    def _preprocess(self,img):
        ...
        """
        img = cv2.resize(img, None, fx=SCALE_FACTOR, fy=SCALE_FACTOR, interpolation=INTERPOLATION_METHOD)
